        ...
        <section ref={sectionRef} className="w-full rounded-t-3xl bg-background overflow-hidden relative">
            ...
            >
                ...
                <div className="relative z-10 flex flex-col items-center gap-10 max-w-5xl mx-auto">
                    ...
                    {/* Heading */}
                    <div className="cta-title text-5xl md:text-7xl lg:text-8xl font-medium tracking-tighter drop-shadow-2xl flex flex-col leading-[1] text-black dark:text-white">
                        <span>Ready to scale your</span>
                        <span className="">brand  <span className="text-primary dark:text-primary">vision?</span></span>
                    </div>

                    {/* Subtext */}
                    <p className="cta-desc text-lg md:text-xl max-w-2xl leading-relaxed drop-shadow-md text-black dark:text-white">
                    ...
                    <div className="cta-btns flex flex-col sm:flex-row items-center gap-6 pt-6">
                        <Button variant={"link"} className="h-16 px-12 text-lg group flex items-center gap-2 dark:text-white dark:hover:text-black text-black hover:text-primary" onClick={()=>navigate("/portfolio")}>
                            View Portfolio
                            <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                        </Button>
                        <Button className="h-16 px-12 text-lg border-none shadow-[0_0_30px_-5px_rgba(255,255,255,0.3)] hover:shadow-[0_0_40px_-5px_rgba(255,255,255,0.5)] transition-all duration-300 hover:scale-105" onClick={()=>navigate("/contact")}>
